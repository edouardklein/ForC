...
#?l l_PROB_MATRIX 'P'
#?dg PROB_MATRIX 'l_PROB_MATRIX SUBSCRIPT ACTION | l_PROB_MATRIX SUBSCRIPT POLICY' '$P_x$ with $x$ and action or policy'  'Probability transition matrix for an action or a policy'
